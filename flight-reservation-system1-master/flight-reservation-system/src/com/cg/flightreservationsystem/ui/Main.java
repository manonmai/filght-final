		...
		do {
			...
			try
			{
				...
				case "1":
					...
					boolean flag = flight.modify(flightId,capacity);
					if(flag==true)
					{
					...
					break;
				case "2":
					//FlightDetailOperations flight1 = new FlightDetailOperationsImpl();
					List <FlightDTO>flightList1 = new ArrayList<FlightDTO>();
					flightList1.addAll(flight.view());
				...
				case "3":
					...
					case "1":
						...
						String source;
						source = input.next();
						if(validate.isPlaceValid(source));
						boolean flag1;
					...
					case "2":
						...
						if(validate.isPlaceValid(destination));
						boolean flag2;
				...
				case "5":
					...
					scheduleList.addAll(schedule.view());
				...
				case "6":
					...
					scheduleList1.addAll(schedule.view());
